function Formu({ }) {
    return (
        <form className="border-2 border-gray-500 relative my-3 mx-8 justify-center w-auto h-auto lg:w-2/8 lg:mt-5 flex lg:mr-5 lg:flex-wrap lg:align-middle ">
            <fieldset className="border relative w-full h-full bg-pink-300 flex flex-wrap " >
                ...
                <div className="m-2 h-12 w-full flex p-0 lg:w-2/5 align-middle  ">
                    <div className="ml-4">
                        <label className="lbl" for="cmbmarca">Marca</label>
                            <select name="cmbmarca" id="cmbmarca" required>
                    ...
                    <div>
                        <label className="lbl" for="cmbcategoria">Categoría</label>
                            <select name="cmbcategoria" id="cmbcategoria" required>
                                <option selected value="">Seleccionar...</option>
                ...
                <div className="flex  h-12 w-full lg:w-2/5 m-2">
                  <div id="bexterior" className=" h-8 text-center align-middle flex border border-gray-400 bg-gray-500 w-full lg:h-12">
                    </div>
                </div>
