...
import producto4 from '../../img/0.1-min.png';
import producto5 from '../../img/0.2-min.png';
import producto6 from '../../img/0.3-min.png';
...
function Collares(){
    ...
    //const [pics2, setPics2]= useState([producto4, producto5, producto6]);
